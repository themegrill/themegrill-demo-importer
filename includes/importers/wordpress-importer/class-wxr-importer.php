...
require __DIR__ . '/class-wxr-parser.php';

/** WXR_Parser_SimpleXML class */
require __DIR__ . '/class-wxr-parser-simplexml.php';

/** WXR_Parser_XML class */
require __DIR__ . '/class-wxr-parser-xml.php';

/** WXR_Parser_Regex class */
require __DIR__ . '/class-wxr-parser-regex.php';
