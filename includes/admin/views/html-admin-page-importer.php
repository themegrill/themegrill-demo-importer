		...
		<div class="theme-actions">
			...
			<# } else { #>
				...
				<# } else if ( data.requiredThemeVersion ) { #>
					<a class="button button-primary" href="<?php echo current_user_can( 'update_themes' ) ? esc_url( admin_url( '/update-core.php' ) ) : '#'; ?>" title="{{ data.updateThemeNotice }}" target="_blank"><?php esc_html_e( 'Update Theme', 'themegrill-demo-importer' ); ?></a>
				<# } else { #>
					<?php
					/* translators: %s: Demo name */
	...
	<div class="wp-full-overlay-sidebar">
		...
		<div class="wp-full-overlay-footer">
			<div class="demo-import-actions">
				...
				<# } else if ( data.requiredThemeVersion ) { #>
					<a class="button button-hero button-primary" href="<?php echo current_user_can( 'update_themes' ) ? esc_url( admin_url( '/update-core.php' ) ) : '#'; ?>" title="{{ data.updateThemeNotice }}" target="_blank"><?php esc_html_e( 'Update Theme', 'themegrill-demo-importer' ); ?></a>
				<# } else { #>
					<# if ( data.active ) { #>
