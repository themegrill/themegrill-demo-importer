...
* Fix - Install Companion Elementor from ThemeGrill's packaged GitHub ZIP when it is not on WordPress.org; skip install when already active.
* Fix - Remap classic `[everest_form id="…"]` shortcodes after import so Contact pages render the form.
