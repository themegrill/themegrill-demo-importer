			...
			<div className="mb-[28px] px-[20px]">
				...
				>
					<CheckboxPrimitive.Root
						...
						className="flex items-center justify-center flex-shrink-0 w-4 h-4 mt-[2px] rounded-[3px] border border-[#C8CDD6] bg-white data-[state=checked]:bg-[#2563EB] data-[state=checked]:border-[#2563EB] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-1"
					>
