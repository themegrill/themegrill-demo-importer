...
const PlanDropdown = ({ plans, plan, setPlan, searchParams, setSearchParams }: Props) => {
	...
	return (
		<TGDropdownMenu>
			<DropdownMenuTrigger asChild>
				<Button
					variant="outline"
					className="text-[#383838] px-5 bg-white border-[1px] border-solid cursor-pointer border-[#f4f4f4] w-full sm:w-[130px] h-11 items-center justify-between focus-visible:ring-0"
				>
