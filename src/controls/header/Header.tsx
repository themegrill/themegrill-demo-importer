...
import colormag from '../../assets/images/colormag.png';
	...
	return (
		...
		>
			<TabsList className="border-[1px] border-solid border-[#f4f4f4] p-0 rounded-md overflow-hidden">
				<TabsTrigger
					value="all"
					className="tg-tabs border-none bg-white px-[20px] py-[11px] h-11"
				...
				<TabsTrigger
					value="zakra"
					className="tg-tabs border-[0px] border-l-[1px] border-solid border-[#f4f4f4] bg-white px-[20px] py-[11px] h-11"
					onClick={() => handleClick('zakra')}
				>
					<svg
					...
					<span className="pl-2">Zakra</span>
				</TabsTrigger>
				<TabsTrigger
					value="colormag"
					className="tg-tabs border-[0px] border-l-[1px] border-solid border-[#f4f4f4] bg-white px-[20px] py-[11px] h-11"
					onClick={() => handleClick('colormag')}
				>
					<img src={colormag} alt="" />
					<span className="pl-2">ColorMag</span>
				</TabsTrigger>
			</TabsList>
